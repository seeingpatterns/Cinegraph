...
> **50편의 추천 영화를 AI 임베딩으로 분석하고, Neural Constellation으로 시각화하는 프로젝트**

인스타그램에서 팔로워들에게 "인생 영화 하나만 추천해주세요"라고 물었습니다.
50편의 영화가 모였고, 각 영화의 시놉시스·테마·추천인 코멘트를 Google Gemini Embedding API로 벡터화한 뒤,
...
[Live Demo (GitHub Pages)](https://tmx0907.github.io/Trace/)
